...
REM *** Uninstall all provisioned packages ***
DISM /Online /Get-ProvisionedAppxPackages | select-string Packagename | % {$_ -replace "PackageName : ",""} | ForEach-Object {
  PowerShell -Command "DISM /Online /Remove-ProvisionedAppxPackage /PackageName:$_"
}
